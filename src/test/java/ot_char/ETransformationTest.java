...
public class ETransformationTest {
    @Test
    public void ii() {
        ...
        Insertion ret = ETransformation.ii(a, b);
        assertEquals("Test for ii", ret.getPos(), 1);
    ...
    public void dd() {
        ...
        Deletion ret = ETransformation.dd(a, b);
        assertEquals("Test for dd", ret.getPos(), 3);
    }
    ...
    public void id() {
        ...
        Insertion ret = ETransformation.id(a, b);
    ...
    public void di() {
        ...
        Deletion a = new Deletion(stateVector, 2);
        Insertion b = new Insertion(stateVector, 1, 'b');
        Deletion ret = ETransformation.di(a, b);
        assertEquals("Test for di", ret.getPos(), 1);
    }
    ...
    public void lit() {
        ...
        ops.add(d);
        ops.add(e);
        Op ret = ETransformation.LET(a, ops);
        assertEquals("Test for LIT", ((Deletion) ret).getPos(), 2);
    }
}
